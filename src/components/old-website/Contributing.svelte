...
<div id="contributing" class="cdp-bg-yellow">
  <div class="mzp-l-content mzp-t-content-xl">
    <article class="mzp-c-article">
      <h1 class="mzp-c-article-title">Contributing</h1>
      <p>
      ...
      <p>
        ...
        reach out on <a class="cdp-link" href="https://www.democracylab.org/index/?section=AboutProject&id=145">DemocracyLab</a>
        or simply start tackling issues in one of our <a class="cdp-link" href="https://github.com/CouncilDataProject">GitHub repositories</a>.
      </p>
      <p>And don't worry, all CDP libraries are available under MIT License.</p>
      <h3>How CDP Works</h3>
      <StepList />
      <h3>Our Tools</h3>
      <dl class="mzp-u-list-styled">
        ...
        <dt>
          <a class="cdp-link" href="https://github.com/CouncilDataProject/cdp-design">
            cdp-design
          </a>
        </dt>
        <dd>
        ...
        <dd>
          ...
          <a href="https://github.com/CouncilDataProject/councildataproject.github.io/issues" class="cdp-link">
            GitHub issue
          </a>
      ...
      <h3>Contributors</h3>
      <p>
        <a class="cdp-link" href="https://jacksonmaxfield.github.io/">Jackson Maxfield Brown</a>
        and <a class="cdp-link" href="https://nicweber.info/">Nic Weber</a>.
      </p>
      <p>
        There have been major contributions from: 
        <a class="cdp-link" href="https://github.com/tohuynh">To Huynh</a> (Full Stack Development), 
        <a class="cdp-link" href="https://www.isaacna.com/">Isaac Na</a> (Backend Development), 
        <a class="cdp-link" href="https://hawkticehurst.com/">Hawk Ticehurst</a> (Frontend Development), 
        <a class="cdp-link" href="https://www.linkedin.com/in/brianjledbetter/">Brian Ledbetter</a> (Frontend Development), 
        <a class="cdp-link" href="https://www.katlynmfgreene.com/">Katlyn M.F. Greene</a> (UX Research), 
        <a class="cdp-link" href="https://www.emilygilles.design/">Emily Gilles</a> (UX Design), and 
        <a class="cdp-link" href="https://www.linkedin.com/in/madeleine-farrer-14a1a3118/"> Madeleine Farrer</a> (Logo Design).
      </p>
      <p>
        Much of our second prototype can be attributed to the voluteers from
        <a class="cdp-link" href="https://medium.com/democracylab-org/textio-engages-employees-to-accelerate-civic-innovation-5984609a95ce">Textio</a>.
      </p>
      <p>
        Many volunteers and contributors have found the project through
        <a class="cdp-link" href="https://www.democracylab.org/index/?section=Home">DemocracyLab</a>.
      </p>
    </article>
  </div>
</div>